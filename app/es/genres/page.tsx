    ...
    <main className="min-h-screen bg-[#0e0c0a] px-5 py-10 text-[#f5f2ed] md:px-8 md:py-14">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="border-b border-white/10 pb-8">
          <p className="text-[11px] uppercase tracking-[0.3em] text-[#c9a96e]">Salas de lectura</p>
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-[#e8e4df]/80">
            Every room browses connected sources — Open Library, Gutenberg, and more. Elige un género and
